...
const createOrderSchema = z.object({
    ...
    stock_type: z.string().refine((val) => (val === "indices" || val === "midcap" || val === "options" || val === "futures" || val === "commodities" || val === "stocksDerivatives" || val === "currencies") ? true : false, {
        message: "stock_type should be one among ( indices ,midcap ,options ,futures ,commodities ,derivatives ,currencies)"
    })
})
